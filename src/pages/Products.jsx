...
const Products = () => {
  ...
  // Resolve product rating from aggregate first, then fallback to reviews average.
  const getProductRating = (product) => {
    const aggregateRating = Number(product?.ratings);
    if (!Number.isNaN(aggregateRating)) return aggregateRating;
  ...
  useEffect(() => {
    ...
    if (ratingFilter) {
      filteredProducts = filteredProducts.filter((product) => {
        ...
        return productRating >= Number(ratingFilter);
      });
    }
